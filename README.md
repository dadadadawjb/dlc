...
* Know common commands.
  ...
  rsync -avz --progress -e "ssh -p <port>" <src_path> <username>@<ip>:<dst_path> # remote sync, local and remote both need install by `sudo apt install rsync`
...
* Instructions as 
  ...
  我是一名[TODO]，研究的主要方向是[TODO]，现在我主要需要[TODO]。
  ...
  - 中文告诉我：
    ...
    7. 如果我回到这篇论文的研究的那个时候，我可以如何想到这个idea？
    8. 参考我当前做的研究项目或者我整体的研究方向，我可以借鉴什么？
